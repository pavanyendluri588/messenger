...
"""
import socket
server = socket.socket()#has two arguments 1 is type of network ipv4 or ipv6 & 2ns one is tcp or udp by default tcp
print("socket is created")
server.bind(('localhost',9999))#object is passed because only one argument
